...
class DynamicBarcodeProductTemplateLabelsParser(models.AbstractModel):
	_name = 'report.dynamic_barcode_labels.product_temp_barcode_labels_new'
	...
	def _get_report_values(self, docids, data=None):
		barcode_labels_report = self.env['ir.actions.report']._get_report_from_name('dynamic_barcode_labels.product_temp_barcode_labels_new')
		barcode_labels = data['form']['barcode_labels']
		barcode_labels = self.env['barcode.product.template.labels.wiz.line.new'].browse(barcode_labels)
		return {
