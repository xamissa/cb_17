...
class DynamicBarcodePurchaseLabelsParser(models.AbstractModel):
	_name = 'report.dynamic_barcode_labels.pur_dynamic_barcode_labels'
	...
	def _get_report_values(self, docids, data=None):
		barcode_labels_report = self.env['ir.actions.report']._get_report_from_name('dynamic_barcode_labels.pur_dynamic_barcode_labels')
